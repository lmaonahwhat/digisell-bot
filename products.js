...
const steamGames = [
  {
    ...
    type: "game",
    name: "Dying Light",
    shortName: "Dying Light",
    steamTitle: "Dying Light",
    img: "./img/steam/dying-light/dying-light-standard.jpg",

    categories: ["Лидеры продаж", "digisell-weekly", "Экшен", "Зомби"],
    badges: ["Steam", "Автодоставка"],

    delivery: {
      type: "gift",
      title: "Способ получения",
      text:
        "После оплаты вы получаете инструкцию и данные для получения товара. " +
        "Товар выдается автоматически, без ожидания оператора.",
    },

    description:
      "Dying Light — это экшен-хоррор с открытым миром, паркуром и выживанием среди заражённых. " +
      "Днем вы исследуете город и собираете ресурсы, ночью опасность резко возрастает.\n\n" +
      "Что входит:\n" +
      "• Базовая версия Dying Light\n" +
      "• Полный доступ к основной игре\n" +
      "• Подходит для выбранного региона Steam-аккаунта",

    composition: [
      "Базовая игра Dying Light",
      "Оригинальный игровой контент",
      "Поддержка выбранного региона аккаунта",
      "Инструкция после оплаты",
    ],

    contents: ["Dying Light (Base Game)"],

    prices: {
      RU: { amount: 890, oldAmount: 1090, discount: "-18%" },
      KZ: { amount: 990, oldAmount: 1190, discount: "-17%" },
      UA: { amount: 950, oldAmount: 1150, discount: "-17%" },
      TR: { amount: 840, oldAmount: 990, discount: "-15%" },
      IN: { amount: 820, oldAmount: 970, discount: "-15%" },
    },
  },

  {
    id: 1102,
    slug: "dying-light-enhanced",
    groupId: "dying-light",
    edition: "enhanced",
    isBaseGame: false,
    parentGameId: 1101,
    ...
    shortName: "Enhanced Edition",
    steamTitle: "Dying Light",
    img: "./img/steam/dying-light/dying-light-enhanced.jpg",
    ...
    description:
      "Dying Light Enhanced Edition — расширенное издание с дополнительным контентом и улучшенным набором материалов для более полного прохождения.\n\n" +
      "Что входит:\n" +
      "• Базовая игра Dying Light\n" +
      "• Enhanced Edition контент\n" +
      "• Дополнительные материалы и расширения",
    ...
    contents: [
      ...
      "Enhanced Edition content pack",
      "Дополнительные бонусные материалы",
    ],

    prices: {
      RU: { amount: 1190, oldAmount: 1490, discount: "-20%" },
      KZ: { amount: 1290, oldAmount: 1590, discount: "-19%" },
      UA: { amount: 1250, oldAmount: 1490, discount: "-16%" },
      TR: { amount: 1090, oldAmount: 1290, discount: "-16%" },
      IN: { amount: 1050, oldAmount: 1250, discount: "-16%" },
    },
  },

  {
    id: 1103,
    slug: "dying-light-definitive",
    groupId: "dying-light",
    edition: "definitive",
    isBaseGame: false,
    parentGameId: 1101,
    ...
    shortName: "Definitive Edition",
    steamTitle: "Dying Light",
    img: "./img/steam/dying-light/dying-light-definitive.jpg",

    categories: ["Лидеры продаж", "digisell-weekly", "Экшен", "Зомби"],
    badges: ["Steam", "Автодоставка", "Лучшее издание"],
    ...
    description:
      "Dying Light Definitive Edition — максимально полная версия игры для витрины товара. " +
      "Подходит как основная продающая карточка, потому что сразу показывает полную комплектацию.\n\n" +
      "Что входит:\n" +
      "• Базовая игра Dying Light\n" +
      "• The Following\n" +
      "• Bozak Horde\n" +
    ...
    prices: {
      RU: { amount: 1590, oldAmount: 1990, discount: "-20%" },
      KZ: { amount: 1690, oldAmount: 2090, discount: "-19%" },
      UA: { amount: 1650, oldAmount: 1990, discount: "-17%" },
      TR: { amount: 1490, oldAmount: 1790, discount: "-17%" },
      IN: { amount: 1450, oldAmount: 1750, discount: "-17%" },
    },
  },

  {
    ...
    steamTitle: "Dying Light: The Following",
    img: "./img/steam/dying-light/dlc-the-following.jpg",

    categories: ["DLC", "Зомби"],
    description: "Крупное сюжетное дополнение для Dying Light.",
    composition: ["Дополнение The Following"],
    contents: ["The Following DLC"],

    prices: {
      RU: { amount: 690, oldAmount: 890, discount: "-22%" },
      KZ: { amount: 750, oldAmount: 950, discount: "-21%" },
      UA: { amount: 720, oldAmount: 890, discount: "-19%" },
      TR: { amount: 650, oldAmount: 790, discount: "-18%" },
      IN: { amount: 630, oldAmount: 770, discount: "-18%" },
    },
  },

  {
    id: 1112,
    slug: "dying-light-bozak-horde",
    groupId: "dying-light-dlc",
    edition: "dlc",
    isBaseGame: false,
    parentGameId: 1101,
    ...
    shortName: "Bozak Horde",
    steamTitle: "Dying Light: Bozak Horde",
    img: "./img/steam/dying-light/dlc-bozak-horde.jpg",

    categories: ["DLC", "Зомби"],
    description: "Дополнение Bozak Horde для Dying Light.",
    composition: ["Дополнение Bozak Horde"],
    contents: ["Bozak Horde DLC"],

    prices: {
      RU: { amount: 390, oldAmount: 490, discount: "-20%" },
      KZ: { amount: 430, oldAmount: 530, discount: "-19%" },
      UA: { amount: 410, oldAmount: 510, discount: "-19%" },
      TR: { amount: 360, oldAmount: 450, discount: "-20%" },
      IN: { amount: 350, oldAmount: 430, discount: "-19%" },
    },
  },

  {
    id: 1113,
    slug: "dying-light-cuisine-cargo",
    groupId: "dying-light-dlc",
    edition: "dlc",
    isBaseGame: false,
    parentGameId: 1101,
    ...
    shortName: "Cuisine & Cargo",
    steamTitle: "Dying Light: Cuisine & Cargo",
    img: "./img/steam/dying-light/dlc-cuisine-cargo.jpg",

    categories: ["DLC", "Зомби"],
    description: "Дополнение Cuisine & Cargo для Dying Light.",
    composition: ["Дополнение Cuisine & Cargo"],
    contents: ["Cuisine & Cargo DLC"],

    prices: {
      RU: { amount: 290, oldAmount: 390, discount: "-26%" },
      KZ: { amount: 320, oldAmount: 420, discount: "-24%" },
      UA: { amount: 310, oldAmount: 390, discount: "-21%" },
      TR: { amount: 270, oldAmount: 350, discount: "-23%" },
      IN: { amount: 260, oldAmount: 340, discount: "-23%" },
    },
  },
];
